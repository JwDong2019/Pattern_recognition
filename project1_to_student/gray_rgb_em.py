...
def main():
    ...
    plt.figure(2)
    while (step < 10):
        mean1, mean2, covariation1, covariation2, alpha1, alpha2 = em_train(gra_data, grayscale_image, labels)
    ...
    step = 1
    while (step < 10):
        mean1, mean2, covariation1, covariation2, alpha1, alpha2 = em_train(rgb_data, img, labels)
